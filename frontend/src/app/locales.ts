export const dict = {
  TR: {
    ...
    wakeUpWarning: "Yapay zeka motoru uyanıyor, ilk analiz 1-2 dakika sürebilir. Lütfen bekleyin...",
  ...
  EN: {
    ...
    wakeUpWarning: "The AI engine is waking up, the first analysis may take 1-2 minutes. Please wait...",
